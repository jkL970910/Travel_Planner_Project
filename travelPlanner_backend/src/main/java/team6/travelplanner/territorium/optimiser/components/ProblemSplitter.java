...
//		}
	...
	public List<Subproblem> splitIntoSubproblems(Random random, int[] assignment, int nbSubproblems, Customer2CustomerClosestNgbMatrix customer2CustomerClosestNgbMatrix) {
		...
		ImmutableSolution splitSolution = new Solver(splitProblem, new SolverConfig(), random).constructRandWeightBasedPlusLocalSearchSingleStepSol(Cost.createApproxEqualComparator());
